...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_model_label": "Mistral Modell:",
    "settings.ai.mistral_group": "Mistral API (erforderlich)",
    "settings.ai.summary_group": "Epische Zusammenfassung",
    "settings.ai.provider_label": "Erstellt von:",
    "settings.ai.provider_mistral": "Mistral API",
    "settings.ai.provider_claude": "Claude CLI (lokal)",
    "settings.ai.claude_model_label": "Claude Modell:",
    "settings.ai.btn_refresh_models": "Aktualisieren",
    "settings.ai.claude_detected": "Claude CLI erkannt — {version}",
    "settings.ai.claude_not_found": "Claude CLI auf diesem Computer nicht gefunden.",
    "settings.ai.transcription_note": "Der Mistral API Key bleibt erforderlich: Die Audiotranskription läuft immer über Mistral.",
    ...
    "settings.advanced.themed_cursors": "Thematische Cursor in Editoren verwenden",
    ...
    "session.btn.bookmark_tooltip": "Lesezeichen hinzufuegen (F2)",
    "session.bookmark.placeholder": "Bezeichnung (optional)...",
    "session.bookmark.default_label": "Lesezeichen {n}",
    ...
    "session.status.transcribing_file": "Datei {index}/{count}: {name}",
    ...
    "session.status.imported_multi": "{count} Dateien importiert ({size} insgesamt)",
    "session.status.imported_transcript": "Transkript importiert: {name} ({size})",
    ...
    "session.menu.import_audio": "Audio / Transkript importieren",
    "session.menu.save_audio": "Audio speichern",
    "session.menu.resummarize_past": "Vergangene Sitzung neu zusammenfassen",
    "session.menu.copy_summary": "Zusammenfassung kopieren",
    "session.resummarize.title": "Vergangene Sitzung neu zusammenfassen",
    "session.resummarize.no_sessions": "Keine vergangenen Sitzungen mit Transkripten gefunden.",
    "session.resummarize.replace_journal": "Journaleintrag ersetzen",
    "session.resummarize.btn": "Neu zusammenfassen",
    "session.status.replaced_journal": "Journaleintrag ersetzt.",
    ...
    "session.dialog.import_title": "Audio- oder Transkriptdatei(en) importieren",
    "session.order.title": "Reihenfolge der Sitzungsdateien",
    "session.order.hint": "Die Dateien werden in dieser Reihenfolge nacheinander verarbeitet: Audiodateien werden transkribiert, Transkripte werden unverändert eingefügt. Zum Umsortieren ziehen oder die Schaltflächen unten benutzen.",
    "session.order.btn_up": "Nach oben",
    "session.order.btn_down": "Nach unten",
    "session.order.btn_remove": "Entfernen",
    "session.order.btn_add": "Dateien hinzufügen...",
    "session.order.type_audio": "Audio",
    "session.order.type_transcript": "Transkript",
    "session.dialog.import_filter": "Audio und Transkripte (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Audiodateien (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transkripte (*.txt *.md *.text);;Alle (*)",
    ...
    "session.error.drop_while_recording": "Import während der Aufnahme nicht möglich.",
    "session.drop.hint": "Audio- oder Transkriptdateien hier ablegen",
    "session.drop.formats": "Unterstützt: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "app.menu.shortcuts": "Tastenkürzel...",
    "shortcuts.title": "Tastenkürzel",
    "shortcuts.group.general": "Allgemein",
    "shortcuts.group.recording": "Aufnahme",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "TTS-Wiedergabe",
    "shortcuts.settings": "Einstellungen",
    "shortcuts.save": "Speichern",
    "shortcuts.quit": "Beenden",
    "shortcuts.help": "Diese Hilfe anzeigen",
    "shortcuts.record": "Aufnahme starten / stoppen",
    "shortcuts.bookmark": "Lesezeichen hinzufügen",
    "shortcuts.find": "Im Dokument suchen",
    "shortcuts.bold": "Fett",
    "shortcuts.italic": "Kursiv",
    "shortcuts.underline": "Unterstrichen",
    "shortcuts.fold_section": "Abschnitt einklappen",
    "shortcuts.unfold_section": "Abschnitt ausklappen",
    "shortcuts.fold_all": "Alle einklappen",
    "shortcuts.unfold_all": "Alle ausklappen",
    "shortcuts.tts_pause": "Pause / Fortsetzen",
    "shortcuts.ask_campaign": "Kampagne befragen",
    "shortcuts.tts_stop": "Stopp",

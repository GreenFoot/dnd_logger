...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Transkription abgeschlossen. Zusammenfassung wird erstellt...",
    ...
    "session.btn.transcribe": "Transkribieren und Zusammenfassen",
    ...
    "session.post.btn_transcribe": "Transkribieren und Zusammenfassen",

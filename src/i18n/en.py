...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_group": "Mistral API (required)",
    "settings.ai.summary_group": "Epic summary",
    "settings.ai.provider_label": "Generated by:",
    ...
    "settings.ai.btn_refresh_models": "Refresh",
    "settings.ai.claude_detected": "Claude CLI detected — {version}",
    "settings.ai.claude_not_found": "Claude CLI not found on this computer.",
    "settings.ai.transcription_note": "The Mistral API key is always required: audio transcription runs through Mistral.",
    ...
    "session.btn.bookmark_tooltip": "Add bookmark (F2)",
    "session.bookmark.placeholder": "Label (optional)...",
    "session.bookmark.default_label": "Bookmark {n}",
    ...
    "session.status.imported_multi": "{count} files imported ({size} total)",
    "session.status.imported_transcript": "Transcript imported: {name} ({size})",
    ...
    "session.menu.import_audio": "Import audio / transcript",
    "session.menu.save_audio": "Save audio",
    "session.menu.resummarize_past": "Re-summarize past session",
    "session.menu.copy_summary": "Copy summary",
    "session.resummarize.title": "Re-summarize a past session",
    "session.resummarize.no_sessions": "No past sessions with transcripts found.",
    "session.resummarize.replace_journal": "Replace journal entry",
    "session.resummarize.btn": "Re-summarize",
    "session.status.replaced_journal": "Journal entry replaced.",
    ...
    "session.dialog.import_title": "Import audio or transcript file(s)",
    "session.order.title": "Order of the session files",
    "session.order.hint": "The files are processed one after another in this order: audio files are transcribed, transcript files are inserted as they are. Drag to reorder, or use the buttons below.",
    "session.order.btn_up": "Move up",
    "session.order.btn_down": "Move down",
    "session.order.btn_remove": "Remove",
    "session.order.btn_add": "Add files...",
    "session.order.type_audio": "audio",
    "session.order.type_transcript": "transcript",
    "session.dialog.import_filter": "Audio and transcripts (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Audio files (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transcripts (*.txt *.md *.text);;All (*)",
    ...
    "session.drop.hint": "Drop audio or transcript files here",
    "session.drop.formats": "Supported: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "shortcuts.group.recording": "Recording",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "TTS Playback",
    "shortcuts.settings": "Settings",
    "shortcuts.save": "Save",
    "shortcuts.quit": "Quit",
    "shortcuts.help": "Show this help",
    "shortcuts.record": "Start / Stop recording",
    "shortcuts.bookmark": "Add bookmark",
    "shortcuts.find": "Find in document",
    "shortcuts.bold": "Bold",
    "shortcuts.italic": "Italic",
    "shortcuts.underline": "Underline",
    "shortcuts.fold_section": "Fold section",
    "shortcuts.unfold_section": "Unfold section",
    "shortcuts.fold_all": "Fold all",
    "shortcuts.unfold_all": "Unfold all",
    "shortcuts.tts_pause": "Pause / Resume",
    "shortcuts.ask_campaign": "Ask about campaign",

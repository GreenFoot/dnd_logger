...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Transcription complete. Generating summary...",
    ...
    "session.btn.transcribe": "Transcribe and Summarize",
    ...
    "session.post.btn_transcribe": "Transcribe and Summarize",

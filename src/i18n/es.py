...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_model_label": "Modelo de Mistral:",
    "settings.ai.mistral_group": "API de Mistral (obligatoria)",
    "settings.ai.summary_group": "Resumen épico",
    "settings.ai.provider_label": "Generado por:",
    "settings.ai.provider_mistral": "API de Mistral",
    "settings.ai.provider_claude": "Claude CLI (local)",
    "settings.ai.claude_model_label": "Modelo de Claude:",
    "settings.ai.btn_refresh_models": "Actualizar",
    "settings.ai.claude_detected": "Claude CLI detectado — {version}",
    "settings.ai.claude_not_found": "No se encontró Claude CLI en este ordenador.",
    "settings.ai.transcription_note": "La clave API de Mistral sigue siendo necesaria: la transcripción de audio siempre pasa por Mistral.",
    ...
    "settings.advanced.themed_cursors": "Usar cursores temáticos en los editores",
    ...
    "session.btn.bookmark_tooltip": "Agregar marcador (F2)",
    "session.bookmark.placeholder": "Etiqueta (opcional)...",
    "session.bookmark.default_label": "Marcador {n}",
    ...
    "session.status.transcribing_file": "Archivo {index}/{count}: {name}",
    "session.status.transcribing_segment": "Transcribiendo segmento {count}...",
    "session.status.transcription_done": "Transcripción completada.",
    "session.status.summarizing": "Generando resumen...",
    ...
    "session.status.imported_multi": "{count} archivos importados ({size} en total)",
    "session.status.imported_transcript": "Transcripción importada: {name} ({size})",
    ...
    "session.btn.transcribe": "Transcribir",
    ...
    "session.menu.import_audio": "Importar audio / transcripción",
    "session.menu.save_audio": "Guardar audio",
    "session.menu.resummarize_past": "Re-resumir sesión anterior",
    "session.menu.copy_summary": "Copiar resumen",
    "session.resummarize.title": "Re-resumir una sesión anterior",
    "session.resummarize.no_sessions": "No se encontraron sesiones anteriores con transcripciones.",
    "session.resummarize.replace_journal": "Reemplazar entrada del diario",
    "session.resummarize.btn": "Re-resumir",
    "session.status.replaced_journal": "Entrada del diario reemplazada.",
    "session.tts.read_selection": "Leer selección",
    # ── session_tab.py — PostRecordingDialog ────────────────
    "session.post.title": "Grabación completada",
    "session.post.btn_transcribe": "Transcribir",
    ...
    "session.dialog.import_title": "Importar archivos de audio o transcripciones",
    "session.order.title": "Orden de los archivos de la sesión",
    "session.order.hint": "Los archivos se procesan uno tras otro en este orden: los archivos de audio se transcriben, las transcripciones se insertan tal cual. Arrastra para reordenar o usa los botones de abajo.",
    "session.order.btn_up": "Subir",
    "session.order.btn_down": "Bajar",
    "session.order.btn_remove": "Quitar",
    "session.order.btn_add": "Añadir archivos...",
    "session.order.type_audio": "audio",
    "session.order.type_transcript": "transcripción",
    "session.dialog.import_filter": "Audio y transcripciones (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Archivos de audio (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transcripciones (*.txt *.md *.text);;Todos (*)",
    ...
    "session.error.drop_while_recording": "No se puede importar durante la grabación.",
    "session.drop.hint": "Suelta aquí archivos de audio o transcripciones",
    "session.drop.formats": "Compatibles: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "shortcuts.group.recording": "Grabación",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "Reproducción TTS",
    "shortcuts.settings": "Configuración",
    "shortcuts.save": "Guardar",
    "shortcuts.quit": "Salir",
    "shortcuts.help": "Mostrar esta ayuda",
    "shortcuts.record": "Iniciar / Detener grabación",
    "shortcuts.bookmark": "Añadir marcador",
    "shortcuts.find": "Buscar en el documento",
    "shortcuts.bold": "Negrita",
    "shortcuts.italic": "Cursiva",
    "shortcuts.underline": "Subrayado",
    "shortcuts.fold_section": "Plegar sección",
    "shortcuts.unfold_section": "Desplegar sección",
    "shortcuts.fold_all": "Plegar todo",
    "shortcuts.unfold_all": "Desplegar todo",
    "shortcuts.tts_pause": "Pausa / Reanudar",
    "shortcuts.ask_campaign": "Preguntar sobre la campaña",
    "shortcuts.tts_stop": "Detener",

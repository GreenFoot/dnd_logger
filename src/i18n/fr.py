...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Transcription terminée. Génération du résumé...",
    ...
    "session.btn.transcribe": "Transcrire et Resumer",
    ...
    "session.post.btn_transcribe": "Transcrire et Resumer",

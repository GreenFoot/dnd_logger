...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_model_label": "Modèle Mistral:",
    "settings.ai.mistral_group": "API Mistral (requise)",
    "settings.ai.summary_group": "Résumé épique",
    "settings.ai.provider_label": "Généré par:",
    "settings.ai.provider_mistral": "API Mistral",
    "settings.ai.provider_claude": "Claude CLI (local)",
    "settings.ai.claude_model_label": "Modèle Claude:",
    "settings.ai.btn_refresh_models": "Actualiser",
    "settings.ai.claude_detected": "Claude CLI détecté — {version}",
    "settings.ai.claude_not_found": "Claude CLI introuvable sur cet ordinateur.",
    "settings.ai.transcription_note": "La clé API Mistral reste requise : la transcription audio passe toujours par Mistral.",
    ...
    "settings.advanced.themed_cursors": "Utiliser des curseurs thématiques dans les éditeurs",
    ...
    "session.btn.bookmark_tooltip": "Ajouter un signet (F2)",
    "session.bookmark.placeholder": "Label (optionnel)...",
    "session.bookmark.default_label": "Signet {n}",
    ...
    "session.status.transcribing_file": "Fichier {index}/{count} : {name}",
    ...
    "session.status.imported_multi": "{count} fichiers importés ({size} au total)",
    "session.status.imported_transcript": "Transcription importée: {name} ({size})",
    ...
    "session.menu.import_audio": "Importer audio / transcription",
    "session.menu.save_audio": "Sauvegarder l'audio",
    "session.menu.resummarize_past": "Re-résumer une session passée",
    "session.menu.copy_summary": "Copier le resumé",
    "session.resummarize.title": "Re-résumer une session passée",
    "session.resummarize.no_sessions": "Aucune session passée avec transcription trouvée.",
    "session.resummarize.replace_journal": "Remplacer l'entrée du journal",
    "session.resummarize.btn": "Re-résumer",
    "session.status.replaced_journal": "Entrée du journal remplacée.",
    ...
    "session.dialog.import_title": "Importer des fichiers audio ou des transcriptions",
    "session.order.title": "Ordre des fichiers de la session",
    "session.order.hint": "Les fichiers sont traités les uns après les autres dans cet ordre : les fichiers audio sont transcrits, les transcriptions sont insérées telles quelles. Glissez-déposez pour réordonner, ou utilisez les boutons ci-dessous.",
    "session.order.btn_up": "Monter",
    "session.order.btn_down": "Descendre",
    "session.order.btn_remove": "Retirer",
    "session.order.btn_add": "Ajouter des fichiers...",
    "session.order.type_audio": "audio",
    "session.order.type_transcript": "transcription",
    "session.dialog.import_filter": "Audio et transcriptions (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Fichiers audio (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transcriptions (*.txt *.md *.text);;Tous (*)",
    ...
    "session.error.drop_while_recording": "Impossible d'importer pendant l'enregistrement.",
    "session.drop.hint": "Déposez des fichiers audio ou des transcriptions ici",
    "session.drop.formats": "Formats: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "recap.title": "La derni\u00e8re fois, dans {campaign}\u2026",
    "recap.btn.read_aloud": "Lire \u00e0 voix haute",
    "recap.btn.dismiss": "Fermer",
...
""",
    ...
    "app.menu.shortcuts": "Raccourcis clavier...",
    "shortcuts.title": "Raccourcis clavier",
    "shortcuts.group.general": "Général",
    "shortcuts.group.recording": "Enregistrement",
    "shortcuts.group.editor": "Éditeur",
    "shortcuts.group.tts": "Lecture TTS",
    "shortcuts.settings": "Paramètres",
    "shortcuts.save": "Sauvegarder",
    "shortcuts.quit": "Quitter",
    "shortcuts.help": "Afficher cette aide",
    "shortcuts.record": "Démarrer / Arrêter l'enregistrement",
    "shortcuts.bookmark": "Ajouter un signet",
    "shortcuts.find": "Rechercher dans le document",
    "shortcuts.bold": "Gras",
    "shortcuts.italic": "Italique",
    "shortcuts.underline": "Souligné",
    "shortcuts.fold_section": "Replier la section",
    "shortcuts.unfold_section": "Déplier la section",
    "shortcuts.fold_all": "Tout replier",
    "shortcuts.unfold_all": "Tout déplier",
    "shortcuts.tts_pause": "Pause / Reprendre",
    "shortcuts.ask_campaign": "Interroger la campagne",
    "shortcuts.tts_stop": "Arrêter",

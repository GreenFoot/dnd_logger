...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Trascrizione completata. Generazione del riepilogo...",
    ...
    "session.btn.transcribe": "Trascrivi e Riepiloga",
    ...
    "session.post.btn_transcribe": "Trascrivi e Riepiloga",

...
STRINGS: dict[str, str] = {
    ...
    "app.theme.kw.icewind_dale": "ghiaccio,gelo",
    "app.theme.kw.curse_of_strahd": "maledizione",
    "app.theme.kw.descent_into_avernus": "inferno,discesa",
    "app.theme.kw.tomb_of_annihilation": "tomba,annientamento",
    "app.theme.kw.storm_kings_thunder": "tempesta,gigante,tuono",
    "app.theme.kw.waterdeep_dragon_heist": "acquaprofonda",
    "app.theme.kw.out_of_the_abyss": "abisso,sottosuolo",
    # ── app.py — theme picker ───────────────────────────────
    ...
    "settings.ai.mistral_model_label": "Modello Mistral:",
    "settings.ai.mistral_group": "API Mistral (obbligatoria)",
    "settings.ai.summary_group": "Riepilogo epico",
    "settings.ai.provider_label": "Generato da:",
    "settings.ai.provider_mistral": "API Mistral",
    "settings.ai.provider_claude": "Claude CLI (locale)",
    "settings.ai.claude_model_label": "Modello Claude:",
    "settings.ai.btn_refresh_models": "Aggiorna",
    "settings.ai.claude_detected": "Claude CLI rilevato — {version}",
    "settings.ai.claude_not_found": "Claude CLI non trovato su questo computer.",
    "settings.ai.transcription_note": "La chiave API Mistral resta obbligatoria: la trascrizione audio passa sempre da Mistral.",
    ...
    "settings.advanced.themed_cursors": "Usa cursori tematici negli editor",
    ...
    "session.btn.bookmark_tooltip": "Aggiungi segnalibro (F2)",
    "session.bookmark.placeholder": "Etichetta (opzionale)...",
    "session.bookmark.default_label": "Segnalibro {n}",
    ...
    "session.status.transcribing_file": "File {index}/{count}: {name}",
    ...
    "session.status.imported_multi": "{count} file importati ({size} in totale)",
    "session.status.imported_transcript": "Trascrizione importata: {name} ({size})",
    ...
    "session.menu.import_audio": "Importa audio / trascrizione",
    "session.menu.save_audio": "Salva audio",
    "session.menu.resummarize_past": "Ri-riassumere sessione passata",
    "session.menu.copy_summary": "Copia riepilogo",
    "session.resummarize.title": "Ri-riassumere una sessione passata",
    "session.resummarize.no_sessions": "Nessuna sessione passata con trascrizioni trovata.",
    "session.resummarize.replace_journal": "Sostituisci voce del diario",
    "session.resummarize.btn": "Ri-riassumere",
    "session.status.replaced_journal": "Voce del diario sostituita.",
    ...
    "session.dialog.import_title": "Importa file audio o trascrizioni",
    "session.order.title": "Ordine dei file della sessione",
    "session.order.hint": "I file vengono elaborati uno dopo l’altro in questo ordine: i file audio vengono trascritti, le trascrizioni vengono inserite così come sono. Trascina per riordinare o usa i pulsanti qui sotto.",
    "session.order.btn_up": "Sposta su",
    "session.order.btn_down": "Sposta giù",
    "session.order.btn_remove": "Rimuovi",
    "session.order.btn_add": "Aggiungi file...",
    "session.order.type_audio": "audio",
    "session.order.type_transcript": "trascrizione",
    "session.dialog.import_filter": "Audio e trascrizioni (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;File audio (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Trascrizioni (*.txt *.md *.text);;Tutti (*)",
    ...
    "session.error.drop_while_recording": "Impossibile importare durante la registrazione.",
    "session.drop.hint": "Trascina qui file audio o trascrizioni",
    "session.drop.formats": "Supportati: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "app.menu.shortcuts": "Scorciatoie da tastiera...",
    "shortcuts.title": "Scorciatoie da tastiera",
    "shortcuts.group.general": "Generale",
    "shortcuts.group.recording": "Registrazione",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "Riproduzione TTS",
    "shortcuts.settings": "Impostazioni",
    "shortcuts.save": "Salva",
    "shortcuts.quit": "Esci",
    "shortcuts.help": "Mostra questa guida",
    "shortcuts.record": "Avvia / Ferma registrazione",
    "shortcuts.bookmark": "Aggiungi segnalibro",
    "shortcuts.find": "Cerca nel documento",
    "shortcuts.bold": "Grassetto",
    "shortcuts.italic": "Corsivo",
    "shortcuts.underline": "Sottolineato",
    "shortcuts.fold_section": "Comprimi sezione",
    "shortcuts.unfold_section": "Espandi sezione",
    "shortcuts.fold_all": "Comprimi tutto",
    "shortcuts.unfold_all": "Espandi tutto",
    "shortcuts.tts_pause": "Pausa / Riprendi",
    "shortcuts.ask_campaign": "Chiedi sulla campagna",
    "shortcuts.tts_stop": "Ferma",

...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_model_label": "Mistral-model:",
    "settings.ai.mistral_group": "Mistral API (vereist)",
    "settings.ai.summary_group": "Episch verslag",
    "settings.ai.provider_label": "Gegenereerd door:",
    "settings.ai.provider_mistral": "Mistral API",
    "settings.ai.provider_claude": "Claude CLI (lokaal)",
    "settings.ai.claude_model_label": "Claude-model:",
    "settings.ai.btn_refresh_models": "Vernieuwen",
    "settings.ai.claude_detected": "Claude CLI gedetecteerd — {version}",
    "settings.ai.claude_not_found": "Claude CLI niet gevonden op deze computer.",
    "settings.ai.transcription_note": "De Mistral API-sleutel blijft vereist: audiotranscriptie verloopt altijd via Mistral.",
    ...
    "session.btn.bookmark_tooltip": "Bladwijzer toevoegen (F2)",
    "session.bookmark.placeholder": "Label (optioneel)...",
    "session.bookmark.default_label": "Bladwijzer {n}",
    ...
    "session.status.transcribing_file": "Bestand {index}/{count}: {name}",
    ...
    "session.status.imported_multi": "{count} bestanden geïmporteerd ({size} in totaal)",
    "session.status.imported_transcript": "Transcriptie geïmporteerd: {name} ({size})",
    ...
    "session.menu.import_audio": "Audio / transcriptie importeren",
    ...
    "session.dialog.import_title": "Audiobestanden of transcripties importeren",
    "session.order.title": "Volgorde van de sessiebestanden",
    "session.order.hint": "De bestanden worden in deze volgorde na elkaar verwerkt: audiobestanden worden getranscribeerd, transcripties worden ongewijzigd ingevoegd. Sleep om te herschikken of gebruik de knoppen hieronder.",
    "session.order.btn_up": "Omhoog",
    "session.order.btn_down": "Omlaag",
    "session.order.btn_remove": "Verwijderen",
    "session.order.btn_add": "Bestanden toevoegen...",
    "session.order.type_audio": "audio",
    "session.order.type_transcript": "transcriptie",
    "session.dialog.import_filter": "Audio en transcripties (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Audiobestanden (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transcripties (*.txt *.md *.text);;Alle (*)",
    ...
    "session.error.drop_while_recording": "Kan niet importeren tijdens opname.",
    "session.drop.hint": "Sleep audiobestanden of transcripties hierheen",
    "session.drop.formats": "Ondersteund: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "app.menu.shortcuts": "Sneltoetsen...",
    "shortcuts.title": "Sneltoetsen",
    "shortcuts.group.general": "Algemeen",
    "shortcuts.group.recording": "Opname",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "TTS-weergave",
    "shortcuts.settings": "Instellingen",
    "shortcuts.save": "Opslaan",
    "shortcuts.quit": "Afsluiten",
    "shortcuts.help": "Toon deze hulp",
    "shortcuts.record": "Opname starten / stoppen",
    "shortcuts.bookmark": "Bladwijzer toevoegen",
    "shortcuts.find": "Zoeken in document",
    "shortcuts.bold": "Vet",
    "shortcuts.italic": "Cursief",
    "shortcuts.underline": "Onderstreept",
    "shortcuts.fold_section": "Sectie inklappen",
    "shortcuts.unfold_section": "Sectie uitklappen",
    "shortcuts.fold_all": "Alles inklappen",
    "shortcuts.unfold_all": "Alles uitklappen",
    "shortcuts.tts_pause": "Pauze / Hervatten",
    "shortcuts.ask_campaign": "Vraag over campagne",
    "shortcuts.tts_stop": "Stop",

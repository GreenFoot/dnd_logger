...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Transcriptie voltooid. Samenvatting genereren...",
    ...
    "session.btn.transcribe": "Transcriberen en Samenvatten",
    ...
    "session.post.btn_transcribe": "Transcriberen en Samenvatten",

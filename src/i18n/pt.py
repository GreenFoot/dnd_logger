...
STRINGS: dict[str, str] = {
    ...
    "settings.ai.mistral_model_label": "Modelo Mistral:",
    "settings.ai.mistral_group": "API Mistral (necessária)",
    "settings.ai.summary_group": "Resumo épico",
    "settings.ai.provider_label": "Gerado por:",
    "settings.ai.provider_mistral": "API Mistral",
    "settings.ai.provider_claude": "Claude CLI (local)",
    "settings.ai.claude_model_label": "Modelo Claude:",
    "settings.ai.btn_refresh_models": "Atualizar",
    "settings.ai.claude_detected": "Claude CLI detetado — {version}",
    "settings.ai.claude_not_found": "Claude CLI não encontrado neste computador.",
    "settings.ai.transcription_note": "A chave API Mistral continua a ser necessária: a transcrição de áudio passa sempre pela Mistral.",
    ...
    "settings.advanced.themed_cursors": "Usar cursores temáticos nos editores",
    ...
    "session.btn.bookmark_tooltip": "Adicionar marcador (F2)",
    ...
    "session.status.transcribing_file": "Ficheiro {index}/{count}: {name}",
    ...
    "session.status.imported_multi": "{count} ficheiros importados ({size} no total)",
    "session.status.imported_transcript": "Transcrição importada: {name} ({size})",
    ...
    "session.menu.import_audio": "Importar áudio / transcrição",
    ...
    "session.dialog.import_title": "Importar ficheiros de áudio ou transcrições",
    "session.order.title": "Ordem dos ficheiros da sessão",
    "session.order.hint": "Os ficheiros são processados uns a seguir aos outros por esta ordem: os ficheiros de áudio são transcritos, as transcrições são inseridas tal como estão. Arraste para reordenar ou use os botões abaixo.",
    "session.order.btn_up": "Subir",
    "session.order.btn_down": "Descer",
    "session.order.btn_remove": "Remover",
    "session.order.btn_add": "Adicionar ficheiros...",
    "session.order.type_audio": "áudio",
    "session.order.type_transcript": "transcrição",
    "session.dialog.import_filter": "Áudio e transcrições (*.wav *.mp3 *.flac *.ogg *.m4a *.wma *.txt *.md *.text);;Ficheiros de áudio (*.wav *.mp3 *.flac *.ogg *.m4a *.wma);;Transcrições (*.txt *.md *.text);;Todos (*)",
    ...
    "session.error.drop_while_recording": "Não é possível importar durante a gravação.",
    "session.drop.hint": "Largue aqui ficheiros de áudio ou transcrições",
    "session.drop.formats": "Suportados: FLAC, WAV, MP3, OGG, M4A, TXT, MD",
    # ── rich_editor.py ──────────────────────────────────────
...
""",
    ...
    "recap.title": "Da \u00faltima vez, em {campaign}\u2026",
    "recap.btn.read_aloud": "Ler em voz alta",
    "recap.btn.dismiss": "Fechar",
    "recap.hint.read": "Espa\u00e7o: Ler",
    "recap.hint.dismiss": "Esc: Fechar",
    "settings.advanced.show_recap": "Mostrar resumo da sess\u00e3o ao iniciar",
    "settings.advanced.notification_sounds": "Reproduzir som de notifica\u00e7\u00e3o ao concluir",
    # ── tts_overlay.py ──────────────────────────────────────
...
""",
    ...
    "app.menu.shortcuts": "Atalhos de teclado...",
    "shortcuts.title": "Atalhos de teclado",
    "shortcuts.group.general": "Geral",
    "shortcuts.group.recording": "Gravação",
    "shortcuts.group.editor": "Editor",
    "shortcuts.group.tts": "Reprodução TTS",
    "shortcuts.settings": "Definições",
    "shortcuts.save": "Guardar",
    "shortcuts.quit": "Sair",
    "shortcuts.help": "Mostrar esta ajuda",
    "shortcuts.record": "Iniciar / Parar gravação",
    "shortcuts.bookmark": "Adicionar marcador",
    "shortcuts.find": "Procurar no documento",
    "shortcuts.bold": "Negrito",
    "shortcuts.italic": "Itálico",
    "shortcuts.underline": "Sublinhado",
    "shortcuts.fold_section": "Recolher secção",
    "shortcuts.unfold_section": "Expandir secção",
    "shortcuts.fold_all": "Recolher tudo",
    "shortcuts.unfold_all": "Expandir tudo",
    "shortcuts.tts_pause": "Pausa / Retomar",
    "shortcuts.ask_campaign": "Perguntar sobre a campanha",
    "shortcuts.tts_stop": "Parar",

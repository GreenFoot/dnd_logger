...
STRINGS: dict[str, str] = {
    ...
    "session.status.transcription_done": "Transcrição concluída. A gerar resumo...",
    ...
    "session.btn.transcribe": "Transcrever e Resumir",
    ...
    "session.post.btn_transcribe": "Transcrever e Resumir",
